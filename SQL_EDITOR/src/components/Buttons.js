  ...
  return (
    <div className="flex">
      <div className="p-2">
        <button
          onClick={reset}
          className="flex mx-auto text-white bg-teal-400 border-0 py-2 h-11 px-4 focus:outline-none hover:bg-teal-600 rounded text-lg justify-center items-center"
        >
          <svg
